...
public class V1_1 extends V1_0 {

    private final String baseURL = "https://api.mysportsfeeds.com/v1.1/pull";
    private String league, season, feed, format, param, finalURL;

    public V1_1(String league, String season, String feed, String format, String param) {
